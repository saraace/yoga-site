...
const SignUp = () => {
  ...
  return (
    <>
      <PageBackground src="/images/sign-up/bg.png" />
      <SignUpPage>
        <Container>
          <h1>Get started with a Yoga account!</h1>
            ...
            <PlanOptions>
              <RadioGroup>
                <OptionGroup
                  ...
                  validate={touched.frequency && errors.frequency}
                />
              </RadioGroup>
              <Plans
                plans={monthlyOps}
                ...
                value={values.plan}
                onChange={handleChange}
                validate={touched.plan && errors.plan}
              />
            </PlanOptions>
            <FormFields>
              <Select
              ...
              <PasswordRequirements password={values.password} confirm={values.confirmPassword} checkMatch={true}>
                ...
                <Input
                  ...
                  onChange={handleChange}
                  validate={touched.confirmPassword && errors.confirmPassword}
                />
              ...
              <Input
                ...
                onChange={handleChange}
                validate={touched.nameOnCard && errors.nameOnCard}
              />
              <Input
                ...
                onChange={handleChange}
                validate={touched.cardNumber && errors.cardNumber}
              />
              <Flex>
                <ExpDate>
                  <Input
                    ...
                    onChange={handleChange}
                    validate={touched.expDate && errors.expDate}
                  />
                </ExpDate>
                <CVC>
                  <Input
                    ...
                    value={values.cvc}
                    onChange={handleChange}
                    validate={touched.cvc && errors.cvc}
                  />
                </CVC>
              </Flex>
              <Terms>
                You will be charged <span>$7.99</span> every 1st of the month, You'll be charged <span>$0.24</span> tax.
              </Terms>
