          ...
          <FormSection>
            ...
            <Row>
              <Col12>
                <Select
                  name="training_date"
                  options={trainingDateOps}
                  value={values.training_date}
                  onChange={handleChange}
                  validate={touched.training_date && errors.training_date}
                />
              </Col12>
            </Row>
          </FormSection>
            ...
            <Row>
              <Col6>
                <Input
                  ...
                  onChange={handleChange}
                  validate={touched.first_name && errors.first_name}
                />
              </Col6>
              <Col6>
                <Input
                  ...
                  onChange={handleChange}
                  validate={touched.last_name && errors.last_name}
                />
              </Col6>
            </Row>
            <Row>
              <Col6>
                <Input
                  ...
                  onChange={handleChange}
                  validate={touched.birthdate && errors.birthdate}
                />
              </Col6>
              <Col6>
                <Input
                  ...
                  value={values.age}
                  onChange={handleChange}
                  validate={touched.age && errors.age}
                />
              </Col6>
            </Row>
          </FormSection>
            ...
            <Row>
              <Col12>
                <Input
                  ...
                  onChange={handleChange}
                  validate={touched.street_address && errors.street_address}
                />
              </Col12>
            </Row>
            <Row>
              <Col6>
                <Input
                  ...
                  value={values.city}
                  onChange={handleChange}
                  validate={touched.city && errors.city}
                />
              </Col6>
              <Col6>
                <Select
                  ...
                  value={values.state}
                  onChange={handleChange}
                  validate={touched.state && errors.state}
                />
              </Col6>
              <Col6>
                <Input
                  ...
                  value={values.zip}
                  onChange={handleChange}
                  validate={touched.zip && errors.zip}
                />
              </Col6>
            </Row>
          </Address>
            ...
            <Row>
              ...
              <Col6>
                <Input
                  ...
                  value={values.phone}
                  onChange={handleChange}
                  validate={touched.phone && errors.phone}
                />
              </Col6>
            </Row>
            <Row>
              <Col6>
                <Input
                  ...
                  onChange={handleChange}
                  validate={touched.current_occupation && errors.current_occupation}
                />
              </Col6>
            </Row>
            <Row>
              <Col12>
                <Input
                  name="reccomendation"
                  placeholder="Did a YJ staff member (or training graduate) recommend you to this training? If so, who? We love to give props!"
                  value={values.recommendation}
                  onChange={handleChange}
                  validate={touched.recommendation && errors.recommendation}
                />
              </Col12>
            </Row>
          </FormSection>
          <FormSection>
            ...
            <Row>
              <Col12>
                <Textarea
                  name="experience"
                  placeholder="How long have you been practicing yoga and what styles are you familiar with?"
                  value={values.experience}
                  onChange={handleChange}
                  validate={touched.experience && errors.experience}
                />
              </Col12>
            </Row>
          </FormSection>
          <FormSection>
            ...
            <Row>
              <Col12>
                <Textarea
                  name="expectations"
                  placeholder="What do you expect to gain from your teacher training experience?"
                  value={values.expectations}
                  onChange={handleChange}
                  validate={touched.expectations && errors.expectations}
                />
              </Col12>
            </Row>
          </FormSection>
            ...
            <Row>
              <Col12>
                <Textarea
                  ...
                  placeholder="Describe your dietary habits, health, exercise practices and beliefs."
                  value={values.health_practices}
                  onChange={handleChange}
                  validate={touched.health_practices && errors.health_practices}
                />
              </Col12>
            </Row>
          </FormSection>
          <FormSection>
            ...
            <Row>
              <Col12>
                <Textarea
                  name="other"
                  placeholder="Feel free to tell us any information you'd like to share!"
                  value={values.other}
                  onChange={handleChange}
                  validate={touched.other && errors.other}
                />
              </Col12>
            </Row>
          </FormSection>
            ...
            <Row>
              <Referral>
                <CheckboxGroup
                  ...
                  onChange={handleChange}
                  validate={touched.referral && errors.referral}
                />
              </Referral>
            </Row>
          </FormSection>
                ...
                <CheckboxField>
                  <ValidationWrapper validate={touched.agreement_1 && errors.agreement_1}>
                    <Checkbox
                      ...
                      onChange={handleChange}
                      label="I understand that deposits for Hot Fusion Yoga™ Teacher Training are NON-REFUNDABLE and NON-TRANSFERABLE."
                    />
                  </ValidationWrapper>
                  <AnimatePresence>
                ...
                <CheckboxField>
                  <ValidationWrapper validate={touched.agreement_2 && errors.agreement_2}>
                    <Checkbox
                      ...
                      onChange={handleChange}
                      label="I hereby acknowledge that I have read and understand the terms of my agreement on participating in Hot Fusion Yoga™ Teacher Training. All information subject to change without notification."
                    />
                  </ValidationWrapper>
                  <AnimatePresence>
                ...
                <CheckboxField>
                  <ValidationWrapper validate={touched.agreement_3 && errors.agreement_3}>
                    <Checkbox
                      ...
                      onChange={handleChange}
                      label="I have read &amp; agree to the Yoga Legal Waiver."
                    />
                  </ValidationWrapper>
                  <AnimatePresence>
          ...
          <FormSection>
            <Row>
              <Col6>
                <Input
                  name="signature"
                  placeholder="Your Full Name will act as your signature*"
                  value={values.signature}
                  onChange={handleChange}
                  validate={touched.signature && errors.signature}
                />
              </Col6>
              <Col6>
                <Input
                  ...
                  value={values.date}
                  onChange={handleChange}
                  validate={touched.date && errors.date}
                />
              </Col6>
            </Row>
          </FormSection>
