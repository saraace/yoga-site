    ...
    <>
      ...
      <Container>
        <Headline>
          ...
          <h2>
            The truth is that, from the very first studio location that opened back in 2010, Yoga Site has relied on one
            simple ingredient: <strong>Passion</strong>
          </h2>
        </Headline>
        <Row>
          <div>
          ...
          <TextCol className="right">
            <p>
              From choosing which teachers will lead our various studio locations to the development of our trademark
              SHIFT yoga &amp; fitness program, passion is at the core of everything we do.
            </p>
            <p>
              This heartfelt motivation has served us well as we expanded to include meditative retreats around the
              world, on-location boutiques filled with our favorite lines of healthy living products, and, more
              recently, our SHIFT-certified teacher training and ambassador program.
            </p>
            <ButtonRow>
              <Link href="#">
        ...
        <Row>
          <TextCol className="left">
            ...
            <p>
              As the Yoga Site community continues to grow, we remain committed to giving our members the tools they
              need to look good, feel good, and be mindful each and every day.{" "}
            </p>
            <ButtonRow>
              <Link href="#">
                <a sx={{ variant: "buttons.primary" }}>Schedule a Class</a>
          ...
          <div>
            <SingleImage>
              <img src="/images/about/image_02.jpg" />
            </SingleImage>
          </div>
        </Row>
        <TeamLeadersSection>
          ...
          <TeamLeaders>
            {teamLeaders.map((instructor, i) => {
              return <InstructorCard key={i} variant="large" {...instructor} />;
            })}
          </TeamLeaders>
        </TeamLeadersSection>
